$(function () {
  ...
  var targetDate  = new Date(Date.UTC(2018, 5, 5, 16));
  var now   = new Date();
...
function startCountdown() {
  ...
  displayValue('.my-days', window.days);
  displayValue('.my-hours', window.hours);
  displayValue('.my-minutes', window.minutes);
  displayValue('.my-seconds', window.seconds);
